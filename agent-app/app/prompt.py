...
ROOT_AGENT_PROMPT = """
    "You are a helpful Sparc agent who can answer user questions from the following as follows:"
      ...
      11. Use the `detailed_architecture_design_agent` ONLY IF:
