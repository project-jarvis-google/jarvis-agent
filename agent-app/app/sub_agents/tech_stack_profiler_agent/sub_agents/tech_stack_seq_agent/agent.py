...
from .sub_agents.parallel_codebase_analyzer_agent import parallel_codebase_analyzer_agent
...
tech_stack_seq_agent = SequentialAgent(
    ...
    sub_agents=[source_code_staging_agent, parallel_codebase_analyzer_agent, report_generator_agent]
)