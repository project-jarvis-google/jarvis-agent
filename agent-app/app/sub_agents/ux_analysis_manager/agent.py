...
from .sub_agents.dynamic_analysis_manager.dynamic_analysis_agent import (
    dynamic_analysis_agent,
)
from .sub_agents.flow_definition_manager.flow_definition_agent import (
...
from .sub_agents.static_analysis_manager.static_analysis_agent import (
...
ux_analysis_root_agent = Agent(
    ...
    tools=[
        ...
        ),  # 2) Analyze normalized JSON (argument name = 'request')
    ],
)
