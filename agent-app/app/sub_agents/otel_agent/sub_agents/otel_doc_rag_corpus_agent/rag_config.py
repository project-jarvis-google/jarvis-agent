...
os.environ.setdefault("GOOGLE_CLOUD_LOCATION_OTEL_CORPUS", "us-central1")

# Google Cloud Project Settings
PROJECT_ID = os.environ.get("GOOGLE_CLOUD_PROJECT")  # Replace with your project ID
LOCATION = os.environ.get("GOOGLE_CLOUD_LOCATION_OTEL_CORPUS", "us-central1")  # Default location for Vertex AI and GCS resources
